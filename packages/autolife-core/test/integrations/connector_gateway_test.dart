...
void main() {
  ...
  test('Coordinator logs connector_event rows for each lifecycle call', () async {
  ...
  test('OfflineAwareIntegrationConnector queues pushChanges when offline', () async {
    ...
    expect(
      out.maybeWhen(success: (_) => true, orElse: () => false),
      isTrue,
    );
